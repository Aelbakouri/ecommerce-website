								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Nom du produit</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>prix du produit</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>quantité</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Identifiant de transaction</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
