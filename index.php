	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> S'identifier S'enregistrer</a>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<a href="customer_registration.php?register=1" style="color:white; text-decoration:none;">Créer un compte maintenant</a>
									</form>
								</div>
