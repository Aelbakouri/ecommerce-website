		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="panel panel-primary">
					<div class="panel-heading">Formulaire de connexion client</div>
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<p><br/></p>
							<a href="#" style="color:#333; list-style:none;">mot de passe oublié</a><input type="submit" class="btn btn-success" style="float:right;" Value="Connexion">
